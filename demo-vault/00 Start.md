...
It does that only once you ask it to. A fresh install changes nothing — the notice you may have seen on opening this vault says so — and each page below starts by turning on the behavior it shows.
